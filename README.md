...
- **Store-section grouping**: ingredients can carry an optional `department` (Obst/Gemüse, Frische Theke, Bäckerei, Kühlung, Non-Food, Getränke, Frühstück, Backen, Grundnahrungsmittel); the generated shopping list groups items accordingly with anything unlabelled under "Sonstiges"
